(ns dev-love.core ; Must be ".clj" file, Clojure doesn't auto-load user.cljc
  (:require clojure.java.io
            [xtdb.api :as xt]))

; lazy load dev stuff - for faster REPL startup and cleaner dev classpath
(def start-electric-server! (delay @(requiring-resolve 'dev-love.electric-server-java11-jetty10/start-server!)))
